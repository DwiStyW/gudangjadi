                                                    ...
                                                    <input name="no" type="hidden" class="form-control" id="no" value="<?php echo $data['id'];?>" readonly="readonly"/> 
														...
														<div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <input name="kdgol" type="text" class="form-control" id="kdgol" placeholder="Kode Golongan" value="<?php echo $data['kdgol'];?>" required/>                                                                   
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <input name="namagol" type="text" class="form-control" id="namagol" placeholder="Nama Golongan" value="<?php echo $data['namagol'];?>" required/>                                                                   
                                                                </div>
                                                            </div>
                                                        </div>
