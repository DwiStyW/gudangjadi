...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
    ...
    <title>Barang Keluar | SI Gudang</title>
                    ...
                    <div class="sparkline8-list shadow-reset">
                        ...
                        <div class="sparkline8-graph">
                            <div class="datatable-dashv1-list custom-datatable-overright">
                                <div id="toolbar">
                                        <a href="inputkeluarBU.php"><button class="btn btn-sm btn-primary login-submit-cs" type="submit">Input Bahan Keluar</button></a>										
									...
									<tbody>
										...
										<tr>												                                                  
											...
											<td>
												...
												<a class="btn btn-sm btn-danger" href="hapuskeluar.php?hal=<?php echo $data['kode'];?>&kd=<?php echo $data['no'];?>" onclick="javascript: return confirm('Anda yakin hapus ?')"><i class="fa fa-wrench"></i> Hapus</a></td>
										</tr>
										<?php $no++;} ?>                                                
									</tbody>
                                 </table>
