...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
    ...
    <title>Master Jenis | SI Gudang</title>
                    ...
                    <div class="sparkline8-list shadow-reset">
                        ...
                        <div class="sparkline8-graph">
                            <div class="datatable-dashv1-list custom-datatable-overright">
                                <div id="toolbar">                                        
                                        <a href="inputjenis.php"><button class="btn btn-sm btn-primary login-submit-cs" type="submit">Input Jenis</button></a>										
                                ...
                                <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
									...
									<tbody>
										<?php					
										$tampil=mysqli_query($conn,"select * from jenis order by id ASC");
										...
										<tr>												                                                  
											<td><?php echo $no;?></td>
											<td><?php echo $data['kdjenis']; ?></td>
											<td><?php echo $data['namajenis']; ?></td>
											<td>
                                                <a class="btn btn-sm btn-primary" href="editjenis.php?kd=<?php echo $data['id'];?>"><i class="fa fa-edit"></i> Edit</a>
												<a class="btn btn-sm btn-danger" href="hapusgr.php?hal=hapus&kd=<?php echo $data['id'];?>" onclick="javascript: return confirm('Anda yakin hapus ?')"><i class="fa fa-wrench"></i> Hapus</a></td>
										</tr>
										<?php $no++;} ?>                                                
									</tbody>
                                 </table>
