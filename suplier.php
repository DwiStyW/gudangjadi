...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
    ...
    <title>Master Suplier | SI Gudang</title>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="nav nav-tabs custom-menu-wrap">
                        ...
                        <li class="active"><a href="master.php">Master Barang</a></li>
                    ...
                    <div class="sparkline8-list shadow-reset">
                        ...
                        <div class="sparkline8-graph">
                            <div class="datatable-dashv1-list custom-datatable-overright">
                                <div id="toolbar">                                        
                                        <a href="#"><button class="btn btn-sm btn-primary login-submit-cs" type="submit">Input Suplier</button></a>										
                                ...
                                <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
									<thead>
										<tr>                                                    
											...
											<th data-field="name">Nama Suplier</th>											
									...
									<tbody>
										<?php					
										$tampil=mysqli_query($conn,"select * from suplier order by id desc");
										...
										<tr>												                                                  
											...
											<td><a class="btn btn-sm btn-primary" href="editsup.php?hal=edit&kd=<?php echo $data['id'];?>"><i class="fa fa-edit"></i> Edit</a>
												<a class="btn btn-sm btn-danger" href="hapussup.php?hal=hapus&kd=<?php echo $data['id'];?>" onclick="javascript: return confirm('Anda yakin hapus ?')"><i class="fa fa-wrench"></i> Hapus</a></td>
										</tr>
										<?php $no++;} ?>                                                
									</tbody>
                                 </table>
