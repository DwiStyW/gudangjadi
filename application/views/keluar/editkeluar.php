                                    ...
                                    <div class="col-lg-12">
                                        <div class="all-form-element-inner">
                                            ...
                                            <form enctype="multipart/form-data"
                                                action="<?= base_url("keluar/update_keluar") ?>" method="post">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9">
                                                            <input name="tglform" type="date" class="form-control"
                                                                id="tglform" value="<?php echo $r->tglform; ?>"
                                                                required />
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9">
                                                            <input name="name" type="text" class="form-control"
                                                                id="name" value="<?php echo $nama; ?>"
                                                                readonly="readonly" />
                                                            <input name="kode" type="hidden" class="form-control"
                                                                id="kode" value="<?php echo $r->kode ?>"
                                                                readonly="readonly" />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-2">
                                                            <input readonly id=sat class="form-control"
                                                                value="<?= $master->sat1 ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        <div class="col-lg-3">
                                                            <label
                                                                class="login2 pull-right pull-right-pro">Catatan</label>
                                                        </div>
                                                        <div class="col-lg-9">
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        <div class="col-lg-9">
                                                            <input name="adm" type="hidden" class="form-control"
                                                                id="adm"
