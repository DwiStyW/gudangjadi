...
<table border="1" width="100%">
    <thead>
        <tr>
            ...
            <th rowspan="2" style="text-align: center">Kode Produk</th>
    ...
    <tbody>
        <tr>
            <td style="text-align: center" colspan="11">Saldo</td>
        ...
        <tr>
            ...
            <td style="text-align: center"><?= $r->tanggalform ?></td>
            <td style="text-align: center"><?= $r->noform ?></td>
            <td style="text-align: center"><?= $r->nobatch ?></td>
            <td style="text-align: center"><?= $r->kode ?></td>
            <td><?= $r->nama ?></td>
            <?php
