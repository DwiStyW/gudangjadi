                    ...
                    <div style="width:3760px;">
                        ...
                        <div style="display:flex;justify-content:end">
                            <div style="display:flex;border-right:3px solid">
								...
								foreach ($rak1->result_array() as $r1){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r1['status']=='kosong'){?>background-color:#e3d296<?php }else{?>background-color:#d9b432<?php }?>;width:80px;">
								...
								foreach ($rak2->result_array() as $r2){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r2['status']=='kosong'){?>background-color:#e3d296<?php }else{?>background-color:#d9b432<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                            ...
                            <div style="display:flex;border-right:3px solid">
								...
								foreach ($rak3->result_array() as $r3){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r3['status']=='kosong'){?>background-color:#e3d296<?php }else{?>background-color:#d9b432<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
								...
								foreach ($rak4->result_array() as $r4){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r4['status']=='kosong'){?>background-color:#e3d296<?php }else{?>background-color:#d9b432<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                            ...
                            <div style="display:flex;border-right:3px solid">
								...
								foreach ($rak5->result_array() as $r5){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r5['status']=='kosong'){?>background-color:#e3d296<?php }else{?>background-color:#d9b432<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
								...
								foreach ($rak6->result_array() as $r6){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r6['status']=='kosong'){?>background-color:#e3d296<?php }else{?>background-color:#d9b432<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                            ...
                            <div style="display:flex;border-right:3px solid">
								...
								foreach ($rak7->result_array() as $r7){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r7['status']=='kosong'){?>background-color:#e3d296<?php }else{?>background-color:#d9b432<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
								...
								foreach ($rak8->result_array() as $r8){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r8['status']=='kosong'){?>background-color:#e3d296<?php }else{?>background-color:#d9b432<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                            ...
                            <div style="display:flex;border-right:3px solid">
								...
								foreach ($rak9->result_array() as $r9){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r9['status']=='kosong'){?>background-color:#e3d296<?php }else{?>background-color:#d9b432<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
								...
								foreach ($rak10->result_array() as $r10){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r10['status']=='kosong'){?>background-color:#e3d296<?php }else{?>background-color:#d9b432<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                            ...
                            <div style="display:flex;border-right:3px solid">
								...
								foreach ($rak11->result_array() as $r11){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r11['status']=='kosong'){?>background-color:#e3d296<?php }else{?>background-color:#d9b432<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
								...
								foreach ($rak12->result_array() as $r12){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r12['status']=='kosong'){?>background-color:#e3d296<?php }else{?>background-color:#d9b432<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                            ...
                            <div style="display:flex;border-right:3px solid">
								...
								foreach ($rak13->result_array() as $r13){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r13['status']=='kosong'){?>background-color:#e3d296<?php }else{?>background-color:#d9b432<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
								...
								foreach ($rak14->result_array() as $r14){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r14['status']=='kosong'){?>background-color:#e3d296<?php }else{?>background-color:#d9b432<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
								...
								foreach ($rak15->result_array() as $r15){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r15['status']=='kosong'){?>background-color:#e3d296<?php }else{?>background-color:#d9b432<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                            ...
                            <div style="display:flex;border-right:3px solid">
								...
								foreach ($rak16->result_array() as $r16){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r16['status']=='kosong'){?>background-color:#e3d296<?php }else{?>background-color:#d9b432<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
								...
								foreach ($rak17->result_array() as $r17){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r17['status']=='kosong'){?>background-color:#e3d296<?php }else{?>background-color:#d9b432<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                            ...
                            <div style="display:flex;border-right:3px solid">
								...
								foreach ($rak18->result_array() as $r18){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r18['status']=='kosong'){?>background-color:#e3d296<?php }else{?>background-color:#d9b432<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
								...
								foreach ($rak19->result_array() as $r19){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r19['status']=='kosong'){?>background-color:#e3d296<?php }else{?>background-color:#d9b432<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                            ...
                            <div style="display:flex;border-right:3px solid">
								...
								foreach ($rak20->result_array() as $r20){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r20['status']=='kosong'){?>background-color:#e3d296<?php }else{?>background-color:#d9b432<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
								...
								foreach ($rak21->result_array() as $r21){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r21['status']=='kosong'){?>background-color:#e3d296<?php }else{?>background-color:#d9b432<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                            ...
                            <div style="display:flex;border-right:3px solid">
								...
								foreach ($rak22->result_array() as $r22){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r22['status']=='kosong'){?>background-color:#e3d296<?php }else{?>background-color:#d9b432<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
								...
								foreach ($rak23->result_array() as $r23){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r23['status']=='kosong'){?>background-color:#e3d296<?php }else{?>background-color:#d9b432<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                            ...
                            <div style="display:flex;border-right:3px solid">
								...
								foreach ($rak24->result_array() as $r24){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r24['status']=='kosong'){?>background-color:#e3d296<?php }else{?>background-color:#d9b432<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
								...
								foreach ($rak25->result_array() as $r25){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r25['status']=='kosong'){?>background-color:#e3d296<?php }else{?>background-color:#d9b432<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                            ...
                            <div style="display:flex;border-right:3px solid">
								...
								foreach ($rak26->result_array() as $r26){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r26['status']=='kosong'){?>background-color:#e3d296<?php }else{?>background-color:#d9b432<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
								...
								foreach ($rak27->result_array() as $r27){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r27['status']=='kosong'){?>background-color:#e3d296<?php }else{?>background-color:#d9b432<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                            ...
                            <div style="display:flex;border-right:3px solid">
								...
								foreach ($rak28->result_array() as $r28){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r28['status']=='kosong'){?>background-color:#e3d296<?php }else{?>background-color:#d9b432<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
								...
								foreach ($rak29->result_array() as $r29){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r29['status']=='kosong'){?>background-color:#e3d296<?php }else{?>background-color:#d9b432<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                            ...
                            <div style="display:flex;border-right:3px solid">
								...
								foreach ($rak30->result_array() as $r30){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r30['status']=='kosong'){?>background-color:#e3d296<?php }else{?>background-color:#d9b432<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
								...
								foreach ($rak31->result_array() as $r31){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r31['status']=='kosong'){?>background-color:#e3d296<?php }else{?>background-color:#d9b432<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                            ...
                            <div style="display:flex;border-right:3px solid">
								...
								foreach ($rak32->result_array() as $r32){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r32['status']=='kosong'){?>background-color:#e3d296<?php }else{?>background-color:#d9b432<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
								...
								foreach ($rak33->result_array() as $r33){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r33['status']=='kosong'){?>background-color:#e3d296<?php }else{?>background-color:#d9b432<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
								...
								foreach ($rak34->result_array() as $r34){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r34['status']=='kosong'){?>background-color:#e3d296<?php }else{?>background-color:#d9b432<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                            ...
                            <div style="display:flex;border-right:3px solid">
								...
								foreach ($rak35->result_array() as $r35){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r35['status']=='kosong'){?>background-color:#e3d296<?php }else{?>background-color:#d9b432<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
								...
								foreach ($rak36->result_array() as $r36){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r36['status']=='kosong'){?>background-color:#e3d296<?php }else{?>background-color:#d9b432<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                            ...
                            <div style="display:flex;border-right:3px solid">
								...
								foreach ($rak37->result_array() as $r37){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r37['status']=='kosong'){?>background-color:#e3d296<?php }else{?>background-color:#d9b432<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
								...
								foreach ($rak38->result_array() as $r38){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r38['status']=='kosong'){?>background-color:#e3d296<?php }else{?>background-color:#d9b432<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                            ...
                            <div style="display:flex;border-right:3px solid">
								...
								foreach ($rak39->result_array() as $r39){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r39['status']=='kosong'){?>background-color:#e3d296<?php }else{?>background-color:#d9b432<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
								...
								foreach ($rak40->result_array() as $r40){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r40['status']=='kosong'){?>background-color:#e3d296<?php }else{?>background-color:#d9b432<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                            ...
                            <div style="display:flex;border-right:3px solid">
								...
								foreach ($rak41->result_array() as $r41){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r41['status']=='kosong'){?>background-color:#e3d296<?php }else{?>background-color:#d9b432<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
								...
								foreach ($rak42->result_array() as $r42){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r42['status']=='kosong'){?>background-color:#e3d296<?php }else{?>background-color:#d9b432<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target=" #exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r42['kdpallet']) ?>">
                                            <?= $r42['kdpallet']?></a>
                                    </div>
                                    <?php }
										?>
                            ...
                            <div style="display:flex;border-right:3px solid">
								...
								foreach ($rak43->result_array() as $r43){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r43['status']=='kosong'){?>background-color:#e3d296<?php }else{?>background-color:#d9b432<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
								...
								foreach ($rak44->result_array() as $r44){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r44['status']=='kosong'){?>background-color:#e3d296<?php }else{?>background-color:#d9b432<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                            ...
                            <div style="display:flex;border-right:3px solid">
								...
								foreach ($rak45->result_array() as $r45){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r45['status']=='kosong'){?>background-color:#e3d296<?php }else{?>background-color:#d9b432<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
								...
								foreach ($rak46->result_array() as $r46){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r46['status']=='kosong'){?>background-color:#e3d296<?php }else{?>background-color:#d9b432<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                        ...
                        <div style="display:flex;justify-content:end">
                            <div style="display:flex;border-right:3px solid;border-top:3px solid;">
								...
								foreach ($rak1->result_array() as $r1){?>
                                    <div
										...
										<?php if ($r1['kdpallet']=='J02-C0-01' && $r1['status']=='kosong'){?>background-color:#bff9ff;<?php }else if($r1['kdpallet']=='J02-C0-01' && $r1['status']!='kosong'){?>background-color:#08e4fc;<?php }else if($r1['kdpallet']!='J02-C0-01' && $r1['status']!='kosong'){?>background-color:#d9b432;<?php }else if($r1['kdpallet']!='J02-C0-01' && $r1['status']=='kosong'){?>background-color:#e3d296;<?php }?>width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r1['kdpallet']) ?>"><?= $r1['kdpallet']?></a>
                                    </div>
								...
								foreach ($rak2->result_array() as $r2){?>
                                    <div
                                        style="border:1px solid;padding:3px;
										<?php if ($r2['kdpallet']=='J02-C0-02' && $r2['status']=='kosong'){?>background-color:#bff9ff;<?php }else if($r2['kdpallet']=='J02-C0-02' && $r2['status']!='kosong'){?>background-color:#08e4fc;<?php }else if($r2['kdpallet']!='J02-C0-02' && $r2['status']!='kosong'){?>background-color:#d9b432;<?php }else if($r2['kdpallet']!='J02-C0-02' && $r2['status']=='kosong'){?>background-color:#e3d296;<?php }?>width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r2['kdpallet']) ?>"><?= $r2['kdpallet']?></a>
                                    </div>
                            ...
                            <div style="display:flex;border-right:3px solid;border-top:3px solid">
								...
								foreach ($rak3->result_array() as $r3){?>
                                    <div
                                        style="border:1px solid;padding:3px;
										<?php if ($r3['kdpallet']=='J02-C0-03' && $r3['status']=='kosong'){?>background-color:#bff9ff;<?php }else if($r3['kdpallet']=='J02-C0-03' && $r3['status']!='kosong'){?>background-color:#08e4fc;<?php }else if($r3['kdpallet']!='J02-C0-03' && $r3['status']!='kosong'){?>background-color:#d9b432;<?php }else if($r3['kdpallet']!='J02-C0-03' && $r3['status']=='kosong'){?>background-color:#e3d296;<?php }?>width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r3['kdpallet']) ?>"><?= $r3['kdpallet']?></a>
                                    </div>
								...
								foreach ($rak4->result_array() as $r4){?>
                                    <div
                                        style="border:1px solid;padding:3px;
										<?php if ($r4['kdpallet']=='J02-C0-04' && $r4['status']=='kosong'){?>background-color:#bff9ff;<?php }else if($r4['kdpallet']=='J02-C0-04' && $r4['status']!='kosong'){?>background-color:#08e4fc;<?php }else if($r4['kdpallet']!='J02-C0-04' && $r4['status']!='kosong'){?>background-color:#d9b432;<?php }else if($r4['kdpallet']!='J02-C0-04' && $r4['status']=='kosong'){?>background-color:#e3d296;<?php }?>width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r4['kdpallet']) ?>"><?= $r4['kdpallet']?></a>
                                    </div>
                            ...
                            <div style="display:flex;border-right:3px solid;border-top:3px solid">
								...
								foreach ($rak5->result_array() as $r5){?>
                                    <div
                                        style="border:1px solid;padding:3px;
										<?php if ($r5['kdpallet']=='J02-C0-05' && $r5['status']=='kosong'){?>background-color:#bff9ff;<?php }else if($r5['kdpallet']=='J02-C0-05' && $r5['status']!='kosong'){?>background-color:#08e4fc;<?php }else if($r5['kdpallet']!='J02-C0-05' && $r5['status']!='kosong'){?>background-color:#d9b432;<?php }else if($r5['kdpallet']!='J02-C0-05' && $r5['status']=='kosong'){?>background-color:#e3d296;<?php }?>width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r5['kdpallet']) ?>"><?= $r5['kdpallet']?></a>
                                    </div>
								...
								foreach ($rak6->result_array() as $r6){?>
                                    <div
                                        style="border:1px solid;padding:3px;
										<?php if ($r6['kdpallet']=='J02-C0-06' && $r6['status']=='kosong'){?>background-color:#bff9ff;<?php }else if($r6['kdpallet']=='J02-C0-06' && $r6['status']!='kosong'){?>background-color:#08e4fc;<?php }else if($r6['kdpallet']!='J02-C0-06' && $r6['status']!='kosong'){?>background-color:#d9b432;<?php }else if($r6['kdpallet']!='J02-C0-06' && $r6['status']=='kosong'){?>background-color:#e3d296;<?php }?>width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r6['kdpallet']) ?>"><?= $r6['kdpallet']?></a>
                                    </div>
                            ...
                            <div style="display:flex;border-right:3px solid;border-top:3px solid">
								...
								foreach ($rak7->result_array() as $r7){?>
                                    <div
                                        style="border:1px solid;padding:3px;
										<?php if ($r7['kdpallet']=='J02-C0-07' && $r7['status']=='kosong'){?>background-color:#bff9ff;<?php }else if($r7['kdpallet']=='J02-C0-07' && $r7['status']!='kosong'){?>background-color:#08e4fc;<?php }else if($r7['kdpallet']!='J02-C0-07' && $r7['status']!='kosong'){?>background-color:#d9b432;<?php }else if($r7['kdpallet']!='J02-C0-07' && $r7['status']=='kosong'){?>background-color:#e3d296;<?php }?>width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r7['kdpallet']) ?>"><?= $r7['kdpallet']?></a>
                                    </div>
								...
								foreach ($rak8->result_array() as $r8){?>
                                    <div
                                        style="border:1px solid;padding:3px;
										<?php if ($r8['kdpallet']=='J02-C0-08' && $r8['status']=='kosong'){?>background-color:#bff9ff;<?php }else if($r8['kdpallet']=='J02-C0-08' && $r8['status']!='kosong'){?>background-color:#08e4fc;<?php }else if($r8['kdpallet']!='J02-C0-08' && $r8['status']!='kosong'){?>background-color:#d9b432;<?php }else if($r8['kdpallet']!='J02-C0-08' && $r8['status']=='kosong'){?>background-color:#e3d296;<?php }?>width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r8['kdpallet']) ?>"><?= $r8['kdpallet']?></a>
                                    </div>
                            ...
                            <div style="display:flex;border-right:3px solid;border-top:3px solid">
								...
								foreach ($rak9->result_array() as $r9){?>
                                    <div
                                        style="border:1px solid;padding:3px;
										<?php if ($r9['kdpallet']=='J02-C0-09' && $r9['status']=='kosong'){?>background-color:#bff9ff;<?php }else if($r9['kdpallet']=='J02-C0-09' && $r9['status']!='kosong'){?>background-color:#08e4fc;<?php }else if($r9['kdpallet']!='J02-C0-09' && $r9['status']!='kosong'){?>background-color:#d9b432;<?php }else if($r9['kdpallet']!='J02-C0-09' && $r9['status']=='kosong'){?>background-color:#e3d296;<?php }?>width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r9['kdpallet']) ?>"><?= $r9['kdpallet']?></a>
                                    </div>
								...
								foreach ($rak10->result_array() as $r10){?>
                                    <div
                                        style="border:1px solid;padding:3px;
										<?php if ($r10['kdpallet']=='J02-C0-10' && $r10['status']=='kosong'){?>background-color:#bff9ff;<?php }else if($r10['kdpallet']=='J02-C0-10' && $r10['status']!='kosong'){?>background-color:#08e4fc;<?php }else if($r10['kdpallet']!='J02-C0-10' && $r10['status']!='kosong'){?>background-color:#d9b432;<?php }else if($r10['kdpallet']!='J02-C0-10' && $r10['status']=='kosong'){?>background-color:#e3d296;<?php }?>width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r10['kdpallet']) ?>"><?= $r10['kdpallet']?></a>
                                    </div>
								...
								foreach ($rak11->result_array() as $r11){?>
                                    <div
                                        style="border:1px solid;padding:3px;
										<?php if ($r11['kdpallet']=='J02-C0-11' && $r11['status']=='kosong'){?>background-color:#bff9ff;<?php }else if($r11['kdpallet']=='J02-C0-11' && $r11['status']!='kosong'){?>background-color:#08e4fc;<?php }else if($r11['kdpallet']!='J02-C0-11' && $r11['status']!='kosong'){?>background-color:#d9b432;<?php }else if($r11['kdpallet']!='J02-C0-11' && $r11['status']=='kosong'){?>background-color:#e3d296;<?php }?>width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r11['kdpallet']) ?>"><?= $r11['kdpallet']?></a>
                                    </div>
                            ...
                            <div style="display:flex;border-right:3px solid;border-top:3px solid">
								...
								foreach ($rak12->result_array() as $r12){?>
                                    <div
                                        style="border:1px solid;padding:3px;
										<?php if ($r12['kdpallet']=='J02-C0-12' && $r12['status']=='kosong'){?>background-color:#bff9ff;<?php }else if($r12['kdpallet']=='J02-C0-12' && $r12['status']!='kosong'){?>background-color:#08e4fc;<?php }else if($r12['kdpallet']!='J02-C0-12' && $r12['status']!='kosong'){?>background-color:#d9b432;<?php }else if($r12['kdpallet']!='J02-C0-12' && $r12['status']=='kosong'){?>background-color:#e3d296;<?php }?>width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r12['kdpallet']) ?>"><?= $r12['kdpallet']?></a>
                                    </div>
								...
								foreach ($rak13->result_array() as $r13){?>
                                    <div
                                        style="border:1px solid;padding:3px;
										<?php if ($r13['kdpallet']=='J02-C0-13' && $r13['status']=='kosong'){?>background-color:#bff9ff;<?php }else if($r13['kdpallet']=='J02-C0-13' && $r13['status']!='kosong'){?>background-color:#08e4fc;<?php }else if($r13['kdpallet']!='J02-C0-13' && $r13['status']!='kosong'){?>background-color:#d9b432;<?php }else if($r13['kdpallet']!='J02-C0-13' && $r13['status']=='kosong'){?>background-color:#e3d296;<?php }?>width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r13['kdpallet']) ?>"><?= $r13['kdpallet']?></a>
                                    </div>
                            ...
                            <div style="display:flex;border-right:3px solid;border-top:3px solid">
								...
								foreach ($rak14->result_array() as $r14){?>
                                    <div
                                        style="border:1px solid;padding:3px;
										<?php if ($r14['kdpallet']=='J02-C0-14' && $r14['status']=='kosong'){?>background-color:#bff9ff;<?php }else if($r14['kdpallet']=='J02-C0-14' && $r14['status']!='kosong'){?>background-color:#08e4fc;<?php }else if($r14['kdpallet']!='J02-C0-14' && $r14['status']!='kosong'){?>background-color:#d9b432;<?php }else if($r14['kdpallet']!='J02-C0-14' && $r14['status']=='kosong'){?>background-color:#e3d296;<?php }?>width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r14['kdpallet']) ?>"><?= $r14['kdpallet']?></a>
                                    </div>
								...
								foreach ($rak15->result_array() as $r15){?>
                                    <div
                                        style="border:1px solid;padding:3px;
										<?php if ($r15['kdpallet']=='J02-C0-15' && $r15['status']=='kosong'){?>background-color:#bff9ff;<?php }else if($r15['kdpallet']=='J02-C0-15' && $r15['status']!='kosong'){?>background-color:#08e4fc;<?php }else if($r15['kdpallet']!='J02-C0-15' && $r15['status']!='kosong'){?>background-color:#d9b432;<?php }else if($r15['kdpallet']!='J02-C0-15' && $r15['status']=='kosong'){?>background-color:#e3d296;<?php }?>width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r15['kdpallet']) ?>"><?= $r15['kdpallet']?></a>
                                    </div>
                            ...
                            <div style="display:flex;border-right:3px solid;border-top:3px solid">
								...
								foreach ($rak16->result_array() as $r16){?>
                                    <div
                                        style="border:1px solid;padding:3px;
										<?php if ($r16['kdpallet']=='J02-C0-16' && $r16['status']=='kosong'){?>background-color:#bff9ff;<?php }else if($r16['kdpallet']=='J02-C0-16' && $r16['status']!='kosong'){?>background-color:#08e4fc;<?php }else if($r16['kdpallet']!='J02-C0-16' && $r16['status']!='kosong'){?>background-color:#d9b432;<?php }else if($r16['kdpallet']!='J02-C0-16' && $r16['status']=='kosong'){?>background-color:#e3d296;<?php }?>width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r16['kdpallet']) ?>"><?= $r16['kdpallet']?></a>
                                    </div>
								...
								foreach ($rak17->result_array() as $r17){?>
                                    <div
                                        style="border:1px solid;padding:3px;
										<?php if ($r17['kdpallet']=='J02-C0-17' && $r17['status']=='kosong'){?>background-color:#bff9ff;<?php }else if($r17['kdpallet']=='J02-C0-17' && $r17['status']!='kosong'){?>background-color:#08e4fc;<?php }else if($r17['kdpallet']!='J02-C0-17' && $r17['status']!='kosong'){?>background-color:#d9b432;<?php }else if($r17['kdpallet']!='J02-C0-17' && $r17['status']=='kosong'){?>background-color:#e3d296;<?php }?>width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r17['kdpallet']) ?>"><?= $r17['kdpallet']?></a>
                                    </div>
                            ...
                            <div style="display:flex;border-right:3px solid;border-top:3px solid">
								...
								foreach ($rak18->result_array() as $r18){?>
                                    <div
                                        style="border:1px solid;padding:3px;
										<?php if ($r18['kdpallet']=='J02-C0-18' && $r18['status']=='kosong'){?>background-color:#bff9ff;<?php }else if($r18['kdpallet']=='J02-C0-18' && $r18['status']!='kosong'){?>background-color:#08e4fc;<?php }else if($r18['kdpallet']!='J02-C0-18' && $r18['status']!='kosong'){?>background-color:#d9b432;<?php }else if($r18['kdpallet']!='J02-C0-18' && $r18['status']=='kosong'){?>background-color:#e3d296;<?php }?>width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r18['kdpallet']) ?>"><?= $r18['kdpallet']?></a>
                                    </div>
								...
								foreach ($rak19->result_array() as $r19){?>
                                    <div
                                        style="border:1px solid;padding:3px;
										<?php if ($r19['kdpallet']=='J02-C0-19' && $r19['status']=='kosong'){?>background-color:#bff9ff;<?php }else if($r19['kdpallet']=='J02-C0-19' && $r19['status']!='kosong'){?>background-color:#08e4fc;<?php }else if($r19['kdpallet']!='J02-C0-19' && $r19['status']!='kosong'){?>background-color:#d9b432;<?php }else if($r19['kdpallet']!='J02-C0-19' && $r19['status']=='kosong'){?>background-color:#e3d296;<?php }?>width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r19['kdpallet']) ?>"><?= $r19['kdpallet']?></a>
                                    </div>
                            ...
                            <div style="display:flex;border-right:3px solid;border-top:3px solid">
								...
								foreach ($rak20->result_array() as $r20){?>
                                    <div
                                        style="border:1px solid;padding:3px;
										<?php if ($r20['kdpallet']=='J02-C0-20' && $r20['status']=='kosong'){?>background-color:#bff9ff;<?php }else if($r20['kdpallet']=='J02-C0-20' && $r20['status']!='kosong'){?>background-color:#08e4fc;<?php }else if($r20['kdpallet']!='J02-C0-20' && $r20['status']!='kosong'){?>background-color:#d9b432;<?php }else if($r20['kdpallet']!='J02-C0-20' && $r20['status']=='kosong'){?>background-color:#e3d296;<?php }?>width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r20['kdpallet']) ?>"><?= $r20['kdpallet']?></a>
                                    </div>
								...
								foreach ($rak21->result_array() as $r21){?>
                                    <div
                                        style="border:1px solid;padding:3px;
										<?php if ($r21['kdpallet']=='J02-C0-21' && $r21['status']=='kosong'){?>background-color:#bff9ff;<?php }else if($r21['kdpallet']=='J02-C0-21' && $r21['status']!='kosong'){?>background-color:#08e4fc;<?php }else if($r21['kdpallet']!='J02-C0-21' && $r21['status']!='kosong'){?>background-color:#d9b432;<?php }else if($r21['kdpallet']!='J02-C0-21' && $r21['status']=='kosong'){?>background-color:#e3d296;<?php }?>width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r21['kdpallet']) ?>"><?= $r21['kdpallet']?></a>
                                    </div>
                            ...
                            <div style="display:flex;border-right:3px solid;border-top:3px solid">
								...
								foreach ($rak22->result_array() as $r22){?>
                                    <div
                                        style="border:1px solid;padding:3px;
										<?php if ($r22['kdpallet']=='J02-C0-22' && $r22['status']=='kosong'){?>background-color:#bff9ff;<?php }else if($r22['kdpallet']=='J02-C0-22' && $r22['status']!='kosong'){?>background-color:#08e4fc;<?php }else if($r22['kdpallet']!='J02-C0-22' && $r22['status']!='kosong'){?>background-color:#d9b432;<?php }else if($r22['kdpallet']!='J02-C0-22' && $r22['status']=='kosong'){?>background-color:#e3d296;<?php }?>width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r22['kdpallet']) ?>"><?= $r22['kdpallet']?></a>
                                    </div>
								...
								foreach ($rak23->result_array() as $r23){?>
                                    <div
                                        style="border:1px solid;padding:3px;
										<?php if ($r23['kdpallet']=='J02-C0-23' && $r23['status']=='kosong'){?>background-color:#bff9ff;<?php }else if($r23['kdpallet']=='J02-C0-23' && $r23['status']!='kosong'){?>background-color:#08e4fc;<?php }else if($r23['kdpallet']!='J02-C0-23' && $r23['status']!='kosong'){?>background-color:#d9b432;<?php }else if($r23['kdpallet']!='J02-C0-23' && $r23['status']=='kosong'){?>background-color:#e3d296;<?php }?>width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r23['kdpallet']) ?>"><?= $r23['kdpallet']?></a>
                                    </div>
                            ...
                            <div style="display:flex;border-right:3px solid;border-top:3px solid">
								...
								foreach ($rak24->result_array() as $r24){?>
                                    <div
                                        style="border:1px solid;padding:3px;
										<?php if ($r24['kdpallet']=='J02-C0-24' && $r24['status']=='kosong'){?>background-color:#bff9ff;<?php }else if($r24['kdpallet']=='J02-C0-24' && $r24['status']!='kosong'){?>background-color:#08e4fc;<?php }else if($r24['kdpallet']!='J02-C0-24' && $r24['status']!='kosong'){?>background-color:#d9b432;<?php }else if($r24['kdpallet']!='J02-C0-24' && $r24['status']=='kosong'){?>background-color:#e3d296;<?php }?>width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r24['kdpallet']) ?>"><?= $r24['kdpallet']?></a>
                                    </div>
								...
								foreach ($rak25->result_array() as $r25){?>
                                    <div
                                        style="border:1px solid;padding:3px;
										<?php if ($r25['kdpallet']=='J02-C0-25' && $r25['status']=='kosong'){?>background-color:#bff9ff;<?php }else if($r25['kdpallet']=='J02-C0-25' && $r25['status']!='kosong'){?>background-color:#08e4fc;<?php }else if($r25['kdpallet']!='J02-C0-25' && $r25['status']!='kosong'){?>background-color:#d9b432;<?php }else if($r25['kdpallet']!='J02-C0-25' && $r25['status']=='kosong'){?>background-color:#e3d296;<?php }?>width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r25['kdpallet']) ?>"><?= $r25['kdpallet']?></a>
                                    </div>
                            ...
                            <div style="display:flex;border-right:3px solid;border-top:3px solid">
								...
								foreach ($rak26->result_array() as $r26){?>
                                    <div
                                        style="border:1px solid;padding:3px;
										<?php if ($r26['kdpallet']=='J02-C0-26' && $r26['status']=='kosong'){?>background-color:#bff9ff;<?php }else if($r26['kdpallet']=='J02-C0-26' && $r26['status']!='kosong'){?>background-color:#08e4fc;<?php }else if($r26['kdpallet']!='J02-C0-26' && $r26['status']!='kosong'){?>background-color:#d9b432;<?php }else if($r26['kdpallet']!='J02-C0-26' && $r26['status']=='kosong'){?>background-color:#e3d296;<?php }?>width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r26['kdpallet']) ?>"><?= $r26['kdpallet']?></a>
                                    </div>
								...
								foreach ($rak27->result_array() as $r27){?>
                                    <div
                                        style="border:1px solid;padding:3px;
										<?php if ($r27['kdpallet']=='J02-C0-27' && $r27['status']=='kosong'){?>background-color:#bff9ff;<?php }else if($r27['kdpallet']=='J02-C0-27' && $r27['status']!='kosong'){?>background-color:#08e4fc;<?php }else if($r27['kdpallet']!='J02-C0-27' && $r27['status']!='kosong'){?>background-color:#d9b432;<?php }else if($r27['kdpallet']!='J02-C0-27' && $r27['status']=='kosong'){?>background-color:#e3d296;<?php }?>width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r27['kdpallet']) ?>"><?= $r27['kdpallet']?></a>
                                    </div>
                            ...
                            <div style="display:flex;border-right:3px solid;border-top:3px solid">
								...
								foreach ($rak28->result_array() as $r28){?>
                                    <div
                                        style="border:1px solid;padding:3px;
										<?php if ($r28['kdpallet']=='J02-C0-28' && $r28['status']=='kosong'){?>background-color:#bff9ff;<?php }else if($r28['kdpallet']=='J02-C0-28' && $r28['status']!='kosong'){?>background-color:#08e4fc;<?php }else if($r28['kdpallet']!='J02-C0-28' && $r28['status']!='kosong'){?>background-color:#d9b432;<?php }else if($r28['kdpallet']!='J02-C0-28' && $r28['status']=='kosong'){?>background-color:#e3d296;<?php }?>width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r28['kdpallet']) ?>"><?= $r28['kdpallet']?></a>
                                    </div>
								...
								foreach ($rak29->result_array() as $r29){?>
                                    <div
                                        style="border:1px solid;padding:3px;
										<?php if ($r29['kdpallet']=='J02-C0-29' && $r29['status']=='kosong'){?>background-color:#bff9ff;<?php }else if($r29['kdpallet']=='J02-C0-29' && $r29['status']!='kosong'){?>background-color:#08e4fc;<?php }else if($r29['kdpallet']!='J02-C0-29' && $r29['status']!='kosong'){?>background-color:#d9b432;<?php }else if($r29['kdpallet']!='J02-C0-29' && $r29['status']=='kosong'){?>background-color:#e3d296;<?php }?>width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r29['kdpallet']) ?>"><?= $r29['kdpallet']?></a>
                                    </div>
								...
								foreach ($rak30->result_array() as $r30){?>
                                    <div
                                        style="border:1px solid;padding:3px;
										<?php if ($r30['kdpallet']=='J02-C0-30' && $r30['status']=='kosong'){?>background-color:#bff9ff;<?php }else if($r30['kdpallet']=='J02-C0-30' && $r30['status']!='kosong'){?>background-color:#08e4fc;<?php }else if($r30['kdpallet']!='J02-C0-30' && $r30['status']!='kosong'){?>background-color:#d9b432;<?php }else if($r30['kdpallet']!='J02-C0-30' && $r30['status']=='kosong'){?>background-color:#e3d296;<?php }?>width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r30['kdpallet']) ?>"><?= $r30['kdpallet']?></a>
                                    </div>
                            ...
                            <div style="display:flex;border-right:3px solid;border-top:3px solid">
								...
								foreach ($rak31->result_array() as $r31){?>
                                    <div
                                        style="border:1px solid;padding:3px;
										<?php if ($r31['kdpallet']=='J02-C0-31' && $r31['status']=='kosong'){?>background-color:#bff9ff;<?php }else if($r31['kdpallet']=='J02-C0-31' && $r31['status']!='kosong'){?>background-color:#08e4fc;<?php }else if($r31['kdpallet']!='J02-C0-31' && $r31['status']!='kosong'){?>background-color:#d9b432;<?php }else if($r31['kdpallet']!='J02-C0-31' && $r31['status']=='kosong'){?>background-color:#e3d296;<?php }?>width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r31['kdpallet']) ?>"><?= $r31['kdpallet']?></a>
                                    </div>
								...
								foreach ($rak32->result_array() as $r32){?>
                                    <div
                                        style="border:1px solid;padding:3px;
										<?php if ($r32['kdpallet']=='J02-C0-32' && $r32['status']=='kosong'){?>background-color:#bff9ff;<?php }else if($r32['kdpallet']=='J02-C0-32' && $r32['status']!='kosong'){?>background-color:#08e4fc;<?php }else if($r32['kdpallet']!='J02-C0-32' && $r32['status']!='kosong'){?>background-color:#d9b432;<?php }else if($r32['kdpallet']!='J02-C0-32' && $r32['status']=='kosong'){?>background-color:#e3d296;<?php }?>width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r32['kdpallet']) ?>"><?= $r32['kdpallet']?></a>
                                    </div>
                            ...
                            <div style="display:flex;border-right:3px solid;border-top:3px solid">
								...
								foreach ($rak33->result_array() as $r33){?>
                                    <div
                                        style="border:1px solid;padding:3px;
										<?php if ($r33['kdpallet']=='J02-C0-33' && $r33['status']=='kosong'){?>background-color:#bff9ff;<?php }else if($r33['kdpallet']=='J02-C0-33' && $r33['status']!='kosong'){?>background-color:#08e4fc;<?php }else if($r33['kdpallet']!='J02-C0-33' && $r33['status']!='kosong'){?>background-color:#d9b432;<?php }else if($r33['kdpallet']!='J02-C0-33' && $r33['status']=='kosong'){?>background-color:#e3d296;<?php }?>width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r33['kdpallet']) ?>"><?= $r33['kdpallet']?></a>
                                    </div>
								...
								foreach ($rak34->result_array() as $r34){?>
                                    <div
                                        style="border:1px solid;padding:3px;
										<?php if ($r34['kdpallet']=='J02-C0-34' && $r34['status']=='kosong'){?>background-color:#bff9ff;<?php }else if($r34['kdpallet']=='J02-C0-34' && $r34['status']!='kosong'){?>background-color:#08e4fc;<?php }else if($r34['kdpallet']!='J02-C0-34' && $r34['status']!='kosong'){?>background-color:#d9b432;<?php }else if($r34['kdpallet']!='J02-C0-34' && $r34['status']=='kosong'){?>background-color:#e3d296;<?php }?>width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r34['kdpallet']) ?>"><?= $r34['kdpallet']?></a>
                                    </div>
                            ...
                            <div style="display:flex;border-right:3px solid;border-top:3px solid">
								...
								foreach ($rak35->result_array() as $r35){?>
                                    <div
                                        style="border:1px solid;padding:3px;
										<?php if ($r35['kdpallet']=='J02-C0-35' && $r35['status']=='kosong'){?>background-color:#bff9ff;<?php }else if($r35['kdpallet']=='J02-C0-35' && $r35['status']!='kosong'){?>background-color:#08e4fc;<?php }else if($r35['kdpallet']!='J02-C0-35' && $r35['status']!='kosong'){?>background-color:#d9b432;<?php }else if($r35['kdpallet']!='J02-C0-35' && $r35['status']=='kosong'){?>background-color:#e3d296;<?php }?>width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r35['kdpallet']) ?>"><?= $r35['kdpallet']?></a>
                                    </div>
								...
								foreach ($rak36->result_array() as $r36){?>
                                    <div
                                        style="border:1px solid;padding:3px;
										<?php if ($r36['kdpallet']=='J02-C0-36' && $r36['status']=='kosong'){?>background-color:#bff9ff;<?php }else if($r36['kdpallet']=='J02-C0-36' && $r36['status']!='kosong'){?>background-color:#08e4fc;<?php }else if($r36['kdpallet']!='J02-C0-36' && $r36['status']!='kosong'){?>background-color:#d9b432;<?php }else if($r36['kdpallet']!='J02-C0-36' && $r36['status']=='kosong'){?>background-color:#e3d296;<?php }?>width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r36['kdpallet']) ?>"><?= $r36['kdpallet']?></a>
                                    </div>
                            ...
                            <div style="display:flex;border-right:3px solid;border-top:3px solid">
								...
								foreach ($rak37->result_array() as $r37){?>
                                    <div
                                        style="border:1px solid;padding:3px;
										<?php if ($r37['kdpallet']=='J02-C0-37' && $r37['status']=='kosong'){?>background-color:#bff9ff;<?php }else if($r37['kdpallet']=='J02-C0-37' && $r37['status']!='kosong'){?>background-color:#08e4fc;<?php }else if($r37['kdpallet']!='J02-C0-37' && $r37['status']!='kosong'){?>background-color:#d9b432;<?php }else if($r37['kdpallet']!='J02-C0-37' && $r37['status']=='kosong'){?>background-color:#e3d296;<?php }?>width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r37['kdpallet']) ?>"><?= $r37['kdpallet']?></a>
                                    </div>
								...
								foreach ($rak38->result_array() as $r38){?>
                                    <div
                                        style="border:1px solid;padding:3px;
										<?php if ($r38['kdpallet']=='J02-C0-38' && $r38['status']=='kosong'){?>background-color:#bff9ff;<?php }else if($r38['kdpallet']=='J02-C0-38' && $r38['status']!='kosong'){?>background-color:#08e4fc;<?php }else if($r38['kdpallet']!='J02-C0-38' && $r38['status']!='kosong'){?>background-color:#d9b432;<?php }else if($r38['kdpallet']!='J02-C0-38' && $r38['status']=='kosong'){?>background-color:#e3d296;<?php }?>width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r38['kdpallet']) ?>"><?= $r38['kdpallet']?></a>
                                    </div>
                            ...
                            <div style="display:flex;border-right:3px solid;border-top:3px solid">
								...
								foreach ($rak39->result_array() as $r39){?>
                                    <div
                                        style="border:1px solid;padding:3px;
										<?php if ($r39['kdpallet']=='J02-C0-39' && $r39['status']=='kosong'){?>background-color:#bff9ff;<?php }else if($r39['kdpallet']=='J02-C0-39' && $r39['status']!='kosong'){?>background-color:#08e4fc;<?php }else if($r39['kdpallet']!='J02-C0-39' && $r39['status']!='kosong'){?>background-color:#d9b432;<?php }else if($r39['kdpallet']!='J02-C0-39' && $r39['status']=='kosong'){?>background-color:#e3d296;<?php }?>width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r39['kdpallet']) ?>"><?= $r39['kdpallet']?></a>
                                    </div>
								...
								foreach ($rak40->result_array() as $r40){?>
                                    <div
                                        style="border:1px solid;padding:3px;
										<?php if ($r40['kdpallet']=='J02-C0-40' && $r40['status']=='kosong'){?>background-color:#bff9ff;<?php }else if($r40['kdpallet']=='J02-C0-40' && $r40['status']!='kosong'){?>background-color:#08e4fc;<?php }else if($r40['kdpallet']!='J02-C0-40' && $r40['status']!='kosong'){?>background-color:#d9b432;<?php }else if($r40['kdpallet']!='J02-C0-40' && $r40['status']=='kosong'){?>background-color:#e3d296;<?php }?>width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r40['kdpallet']) ?>"><?= $r40['kdpallet']?></a>
                                    </div>
                            ...
                            <div style="display:flex;border-right:3px solid;border-top:3px solid">
								...
								foreach ($rak41->result_array() as $r41){?>
                                    <div
                                        style="border:1px solid;padding:3px;
										<?php if ($r41['kdpallet']=='J02-C0-41' && $r41['status']=='kosong'){?>background-color:#bff9ff;<?php }else if($r41['kdpallet']=='J02-C0-41' && $r41['status']!='kosong'){?>background-color:#08e4fc;<?php }else if($r41['kdpallet']!='J02-C0-41' && $r41['status']!='kosong'){?>background-color:#d9b432;<?php }else if($r41['kdpallet']!='J02-C0-41' && $r41['status']=='kosong'){?>background-color:#e3d296;<?php }?>width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r41['kdpallet']) ?>"><?= $r41['kdpallet']?></a>
                                    </div>
								...
								foreach ($rak42->result_array() as $r42){?>
                                    <div
                                        style="border:1px solid;padding:3px;
										<?php if ($r42['kdpallet']=='J02-C0-42' && $r42['status']=='kosong'){?>background-color:#bff9ff;<?php }else if($r42['kdpallet']=='J02-C0-42' && $r42['status']!='kosong'){?>background-color:#08e4fc;<?php }else if($r42['kdpallet']!='J02-C0-42' && $r42['status']!='kosong'){?>background-color:#d9b432;<?php }else if($r42['kdpallet']!='J02-C0-42' && $r42['status']=='kosong'){?>background-color:#e3d296;<?php }?>width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r42['kdpallet']) ?>"><?= $r42['kdpallet']?></a>
                                    </div>
                        ...
                        <div style="display:flex;justify-content:end">
                            <div style="display:flex;border-right:3px solid">
								...
								foreach ($rak1->result_array() as $r1){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r1['status']=='kosong'){?>background-color:#f5dfe0<?php }else{?>background-color:#f2aaad<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r1['kdpallet']) ?>"><?= $r1['kdpallet']?></a>
                                    </div>
								...
								foreach ($rak2->result_array() as $r2){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r2['status']=='kosong'){?>background-color:#f5dfe0<?php }else{?>background-color:#f2aaad<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r2['kdpallet']) ?>"><?= $r2['kdpallet']?></a>
                                    </div>
                            ...
                            <div style="display:flex;border-right:3px solid">
								...
								foreach ($rak3->result_array() as $r3){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r3['status']=='kosong'){?>background-color:#f5dfe0<?php }else{?>background-color:#f2aaad<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r3['kdpallet']) ?>"><?= $r3['kdpallet']?></a>
                                    </div>
								...
								foreach ($rak4->result_array() as $r4){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r4['status']=='kosong'){?>background-color:#f5dfe0<?php }else{?>background-color:#f2aaad<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r4['kdpallet']) ?>"><?= $r4['kdpallet']?></a>
                                    </div>
                            ...
                            <div style="display:flex;border-right:3px solid">
								...
								foreach ($rak5->result_array() as $r5){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r5['status']=='kosong'){?>background-color:#f5dfe0<?php }else{?>background-color:#f2aaad<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r5['kdpallet']) ?>"><?= $r5['kdpallet']?></a>
                                    </div>
								...
								foreach ($rak6->result_array() as $r6){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r6['status']=='kosong'){?>background-color:#f5dfe0<?php }else{?>background-color:#f2aaad<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r6['kdpallet']) ?>"><?= $r6['kdpallet']?></a>
                                    </div>
                            ...
                            <div style="display:flex;border-right:3px solid">
								...
								foreach ($rak7->result_array() as $r7){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r7['status']=='kosong'){?>background-color:#f5dfe0<?php }else{?>background-color:#f2aaad<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r7['kdpallet']) ?>"><?= $r7['kdpallet']?></a>
                                    </div>
								...
								foreach ($rak8->result_array() as $r8){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r8['status']=='kosong'){?>background-color:#f5dfe0<?php }else{?>background-color:#f2aaad<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r8['kdpallet']) ?>"><?= $r8['kdpallet']?></a>
                                    </div>
                            ...
                            <div style="display:flex;border-right:3px solid">
								...
								foreach ($rak9->result_array() as $r9){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r9['status']=='kosong'){?>background-color:#f5dfe0<?php }else{?>background-color:#f2aaad<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r9['kdpallet']) ?>"><?= $r9['kdpallet']?></a>
                                    </div>
								...
								foreach ($rak10->result_array() as $r10){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r10['status']=='kosong'){?>background-color:#f5dfe0<?php }else{?>background-color:#f2aaad<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r10['kdpallet']) ?>"><?= $r10['kdpallet']?></a>
                                    </div>
								...
								foreach ($rak11->result_array() as $r11){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r11['status']=='kosong'){?>background-color:#f5dfe0<?php }else{?>background-color:#f2aaad<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r11['kdpallet']) ?>"><?= $r11['kdpallet']?></a>
                                    </div>
                            ...
                            <div style="display:flex;border-right:3px solid">
								...
								foreach ($rak12->result_array() as $r12){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r12['status']=='kosong'){?>background-color:#f5dfe0<?php }else{?>background-color:#f2aaad<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r12['kdpallet']) ?>"><?= $r12['kdpallet']?></a>
                                    </div>
								...
								foreach ($rak13->result_array() as $r13){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r13['status']=='kosong'){?>background-color:#f5dfe0<?php }else{?>background-color:#f2aaad<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r13['kdpallet']) ?>"><?= $r13['kdpallet']?></a>
                                    </div>
                            ...
                            <div style="display:flex;border-right:3px solid">
								...
								foreach ($rak14->result_array() as $r14){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r14['status']=='kosong'){?>background-color:#f5dfe0<?php }else{?>background-color:#f2aaad<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r14['kdpallet']) ?>"><?= $r14['kdpallet']?></a>
                                    </div>
								...
								foreach ($rak15->result_array() as $r15){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r15['status']=='kosong'){?>background-color:#f5dfe0<?php }else{?>background-color:#f2aaad<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r15['kdpallet']) ?>"><?= $r15['kdpallet']?></a>
                                    </div>
                            ...
                            <div style="display:flex;border-right:3px solid">
								...
								foreach ($rak16->result_array() as $r16){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r16['status']=='kosong'){?>background-color:#f5dfe0<?php }else{?>background-color:#f2aaad<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r16['kdpallet']) ?>"><?= $r16['kdpallet']?></a>
                                    </div>
								...
								foreach ($rak17->result_array() as $r17){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r17['status']=='kosong'){?>background-color:#f5dfe0<?php }else{?>background-color:#f2aaad<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r17['kdpallet']) ?>"><?= $r17['kdpallet']?></a>
                                    </div>
                            ...
                            <div style="display:flex;border-right:3px solid">
								...
								foreach ($rak18->result_array() as $r18){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r18['status']=='kosong'){?>background-color:#f5dfe0<?php }else{?>background-color:#f2aaad<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r18['kdpallet']) ?>"><?= $r18['kdpallet']?></a>
                                    </div>
								...
								foreach ($rak19->result_array() as $r19){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r19['status']=='kosong'){?>background-color:#f5dfe0<?php }else{?>background-color:#f2aaad<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r19['kdpallet']) ?>"><?= $r19['kdpallet']?></a>
                                    </div>
                            ...
                            <div style="display:flex;border-right:3px solid">
								...
								foreach ($rak20->result_array() as $r20){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r20['status']=='kosong'){?>background-color:#f5dfe0<?php }else{?>background-color:#f2aaad<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r20['kdpallet']) ?>"><?= $r20['kdpallet']?></a>
                                    </div>
								...
								foreach ($rak21->result_array() as $r21){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r21['status']=='kosong'){?>background-color:#f5dfe0<?php }else{?>background-color:#f2aaad<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r21['kdpallet']) ?>"><?= $r21['kdpallet']?></a>
                                    </div>
                            ...
                            <div style="display:flex;border-right:3px solid">
								...
								foreach ($rak22->result_array() as $r22){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r22['status']=='kosong'){?>background-color:#f5dfe0<?php }else{?>background-color:#f2aaad<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r22['kdpallet']) ?>"><?= $r22['kdpallet']?></a>
                                    </div>
								...
								foreach ($rak23->result_array() as $r23){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r23['status']=='kosong'){?>background-color:#f5dfe0<?php }else{?>background-color:#f2aaad<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r23['kdpallet']) ?>"><?= $r23['kdpallet']?></a>
                                    </div>
                            ...
                            <div style="display:flex;border-right:3px solid">
								...
								foreach ($rak24->result_array() as $r24){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r24['status']=='kosong'){?>background-color:#f5dfe0<?php }else{?>background-color:#f2aaad<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r24['kdpallet']) ?>"><?= $r24['kdpallet']?></a>
                                    </div>
								...
								foreach ($rak25->result_array() as $r25){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r25['status']=='kosong'){?>background-color:#f5dfe0<?php }else{?>background-color:#f2aaad<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r25['kdpallet']) ?>"><?= $r25['kdpallet']?></a>
                                    </div>
                            ...
                            <div style="display:flex;border-right:3px solid">
								...
								foreach ($rak26->result_array() as $r26){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r26['status']=='kosong'){?>background-color:#f5dfe0<?php }else{?>background-color:#f2aaad<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r26['kdpallet']) ?>"><?= $r26['kdpallet']?></a>
                                    </div>
								...
								foreach ($rak27->result_array() as $r27){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r27['status']=='kosong'){?>background-color:#f5dfe0<?php }else{?>background-color:#f2aaad<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r27['kdpallet']) ?>"><?= $r27['kdpallet']?></a>
                                    </div>
                            ...
                            <div style="display:flex;border-right:3px solid">
								...
								foreach ($rak28->result_array() as $r28){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r28['status']=='kosong'){?>background-color:#f5dfe0<?php }else{?>background-color:#f2aaad<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r28['kdpallet']) ?>"><?= $r28['kdpallet']?></a>
                                    </div>
								...
								foreach ($rak29->result_array() as $r29){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r29['status']=='kosong'){?>background-color:#f5dfe0<?php }else{?>background-color:#f2aaad<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r29['kdpallet']) ?>"><?= $r29['kdpallet']?></a>
                                    </div>
								...
								foreach ($rak30->result_array() as $r30){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r30['status']=='kosong'){?>background-color:#f5dfe0<?php }else{?>background-color:#f2aaad<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r30['kdpallet']) ?>"><?= $r30['kdpallet']?></a>
                                    </div>
                            ...
                            <div style="display:flex;border-right:3px solid">
								...
								foreach ($rak31->result_array() as $r31){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r31['status']=='kosong'){?>background-color:#f5dfe0<?php }else{?>background-color:#f2aaad<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r31['kdpallet']) ?>"><?= $r31['kdpallet']?></a>
                                    </div>
								...
								foreach ($rak32->result_array() as $r32){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r32['status']=='kosong'){?>background-color:#f5dfe0<?php }else{?>background-color:#f2aaad<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r32['kdpallet']) ?>"><?= $r32['kdpallet']?></a>
                                    </div>
                            ...
                            <div style="display:flex;border-right:3px solid">
								...
								foreach ($rak33->result_array() as $r33){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r33['status']=='kosong'){?>background-color:#f5dfe0<?php }else{?>background-color:#f2aaad<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r33['kdpallet']) ?>"><?= $r33['kdpallet']?></a>
                                    </div>
								...
								foreach ($rak34->result_array() as $r34){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r34['status']=='kosong'){?>background-color:#f5dfe0<?php }else{?>background-color:#f2aaad<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r34['kdpallet']) ?>"><?= $r34['kdpallet']?></a>
                                    </div>
                            ...
                            <div style="display:flex;border-right:3px solid">
								...
								foreach ($rak35->result_array() as $r35){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r35['status']=='kosong'){?>background-color:#f5dfe0<?php }else{?>background-color:#f2aaad<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r35['kdpallet']) ?>"><?= $r35['kdpallet']?></a>
                                    </div>
								...
								foreach ($rak36->result_array() as $r36){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r36['status']=='kosong'){?>background-color:#f5dfe0<?php }else{?>background-color:#f2aaad<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r36['kdpallet']) ?>"><?= $r36['kdpallet']?></a>
                                    </div>
                            ...
                            <div style="display:flex;border-right:3px solid">
								...
								foreach ($rak37->result_array() as $r37){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r37['status']=='kosong'){?>background-color:#f5dfe0<?php }else{?>background-color:#f2aaad<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r37['kdpallet']) ?>"><?= $r37['kdpallet']?></a>
                                    </div>
								...
								foreach ($rak38->result_array() as $r38){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r38['status']=='kosong'){?>background-color:#f5dfe0<?php }else{?>background-color:#f2aaad<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r38['kdpallet']) ?>"><?= $r38['kdpallet']?></a>
                                    </div>
                            ...
                            <div style="display:flex;border-right:3px solid">
								...
								foreach ($rak39->result_array() as $r39){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r39['status']=='kosong'){?>background-color:#f5dfe0<?php }else{?>background-color:#f2aaad<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r39['kdpallet']) ?>"><?= $r39['kdpallet']?></a>
                                    </div>
								...
								foreach ($rak40->result_array() as $r40){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r40['status']=='kosong'){?>background-color:#f5dfe0<?php }else{?>background-color:#f2aaad<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r40['kdpallet']) ?>"><?= $r40['kdpallet']?></a>
                                    </div>
                            ...
                            <div style="display:flex;border-right:3px solid">
								...
								foreach ($rak41->result_array() as $r41){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r41['status']=='kosong'){?>background-color:#f5dfe0<?php }else{?>background-color:#f2aaad<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r41['kdpallet']) ?>"><?= $r41['kdpallet']?></a>
                                    </div>
								...
								foreach ($rak42->result_array() as $r42){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r42['status']=='kosong'){?>background-color:#f5dfe0<?php }else{?>background-color:#f2aaad<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r42['kdpallet']) ?>"><?= $r42['kdpallet']?></a>
                                    </div>
                        ...
                        <div style="display:flex;justify-content:end">
                            <div style="display:flex;border-right:3px solid">
								...
								foreach ($rak1->result_array() as $r1){?>
                                    <div
                                        style="border:1px solid;padding:3px;<?php if ($r1['status']=='kosong'){?>background-color:#e9c5fc<?php }else{?>background-color:#b185cc<?php }?>;width:80px;">
                                        <a id="lihatPallet" type="button" data-toggle="modal"
                                            data-target="#exampleModal" style="color:black"
                                            href="<?= base_url("mapping/modal/".$r1['kdpallet']) ?>"><?= $r1['kdpallet']?></a>
                                    </div>
