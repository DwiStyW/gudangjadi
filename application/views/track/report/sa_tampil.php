    ...
    <div class="admin-dashone-data-table-area mg-b-40">
        <div class="container " style="position:relative;margin-top:-250px;padding-bottom:51px;z-index: 1">
            <div class="d-flex">
                ...
                <div id="toolbar">
                    <a target="_blank" href="<?= base_url("track/report/printsa/" . $start . "/" . $end) ?>">
                        <button class="btn btn-sm btn-success login-submit-cs" type="submit">Print</button></a>
                    <a href="<?= base_url("track/report/repsa") ?>"><button class="btn btn-sm btn-white" type="button">Kembali</button></a>
                </div>
                    ...
                    <div class="sparkline8-graph">
                        <div class="datatable-dashv1-list custom-datatable-overright">
                            ...
                            <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                ...
                                <tbody>
                                    <?php
                                    $tampil = $this->db->query("SELECT * FROM master, riwayattrack  WHERE master.kode=riwayattrack.kode && riwayattrack.tglform between '$mulai' AND '$end' ORDER BY kdgol ASC, riwayattrack.kode ASC");
