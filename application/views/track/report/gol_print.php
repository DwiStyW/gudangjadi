...
.spasi {
    ...
    <body>
        ...
        ?>
        <h3>Report Saldo Produk Jadi</h3>
        ...
        <table border="1" width="100%">
            ...
            <tbody>
                <?php
                $tampil = $this->db->query("SELECT * FROM master, riwayattrack WHERE master.kode=riwayattrack.kode && master.kdgol='$kode' && riwayattrack.tglform between '$mulai' AND '$end' ORDER BY no ASC");
