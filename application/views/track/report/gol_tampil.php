    ...
    <div class="admin-dashone-data-table-area mg-b-40">
        <div class="container " style="position:relative;top:-250px;z-index: 1">
            <div class="d-flex">
                ...
                <div id="toolbar">
                    <a target="_blank" href="<?= base_url("track/report/gol_print/" . $start . "/" . $end . "/" . $kode) ?>">
                        <button class="btn btn-sm btn-success login-submit-cs" type="submit">Print</button></a>
                    <a href="<?= base_url("track/report/filgolongan") ?>"><button class="btn btn-sm btn-white"
                        ...
                        <div class="datatable-dashv1-list custom-datatable-overright">
                            ...
                            <table id="table" data-toggle="table" data-pagination="true" data-search="true"
                                ...
                                <tbody>
                                    ...
                                    <?php
                                    // $tampil = mysqli_query($conn, "SELECT * FROM master, riwayattrack  WHERE master.kode=riwayattrack.kode && master.kdgol='$kode' && riwayattrack.tglform between '$mulai' AND '$end' ORDER BY no ASC");
                                    ...
                                    <tr>
                                        ...
                                        <!-- Masuk -->
                                        <?php
                                                    $masuk = $this->db->query("SELECT SUM(masuk) AS mas FROM riwayattrack  WHERE kode='$code' && tglform between '$mulai' AND '$end'");
                                        ...
                                        <!-- Keluar -->
                                        <?php
                                                    $keluar = $this->db->query("SELECT SUM(keluar) AS kel FROM riwayattrack  WHERE kode='$code' && tglform between '$mulai' AND '$end'");
