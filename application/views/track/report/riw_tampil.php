            ...
            <div class="d-flex">
                ...
                <div style="background-color:#fff">
                    <div class="sparkline8-graph">
                        <div id="toolbar">
                            <?php ?>
                            <a target="_blank" href="<?= base_url("track/report/printriw/" . "/" . $start . "/" . $end . "/" . $code) ?>">
                                <button class="btn btn-sm btn-success login-submit-cs" type="submit">Print</button></a>
                            <a href="<?= base_url("track/report/riwayat") ?>"><button class=" btn btn-white" type="button">Kembali</button></a>
                        </div>
                        <div class="datatable-dashv1-list custom-datatable-overright">
                            ...
                            <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                ...
                                <tbody>
                                    ...
                                    <?php }
                                    $allin = $this->db->query("SELECT SUM(masuk) AS sumIn FROM riwayattrack WHERE  keluar=0 && kode='$code' && tglform between '$start' AND '$end'");
                                    $allout = $this->db->query("SELECT SUM(keluar) AS sumOut FROM riwayattrack WHERE masuk=0 && kode='$code' && tglform between '$start' AND '$end'");
