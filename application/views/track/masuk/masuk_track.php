                                    ...
                                    <div style="display:flex; flex:wrap">
                                        <div style="width:100%">
                                            ...
                                            <input type="text" name="keyword" value="<?= $keyword?>"
                                                placeholder="Cari Produk Masuk..." class="form-control">
                                            <?php }else{ ?>
                                            <input type="text" name="keyword" placeholder="Cari Produk Masuk..."
                                                class="form-control">
                                            <?php } ?>
                                        </div>
                    ...
                    <table id="table" data-toggle="table" data-pagination="false" data-search="false"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php   $tahun = strrev(substr(substr($batch, -6), 0, 2));
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-sm btn-danger"
                                        href="<?= base_url("track/masuk_track/hapus/" . $m->no . "/" . $m->kode."/".$m->nopallet."/".$m->nobatch."/".$m->masuk."/".$m->noform."/".$m->tglform) ?>"
