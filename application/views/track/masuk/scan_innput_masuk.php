                                        ...
                                        <form enctype="multipart/form-data" id="data" action="<?= base_url("track/masuk_track/tambah_masuk_track") ?>" method="post" class="form">
                                            ...
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input type="text" class="form-control" readonly value="<?=$this->uri->segment(4)?>">
                                                    </div>
                                                    <div class="col-lg-1">
                                                        <a href="<?= base_url("track/masuk_track/input_masuk_track")?>" class="btn btn-sm btn-primary">Reset</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group-inner">
