...
<div class="modal-dialog modal-lg modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Hapus Produk Masuk</h1>
      </div>
      <form action="<?= base_url("masuk/hapus_masuk")?>" method="post">
...
<script>
    function hapus(no,noform,nobatch,kode,isi1,isi2,isi3,sat1,sat2,sat3){
        ...
        $.ajax({
            url: "<?php echo site_url('masuk/getqty'); ?>",
            method: "POST",
            data: {
                noform: noform,
                kode: kode,
