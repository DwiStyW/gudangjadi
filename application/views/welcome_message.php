...
<body class="sign-in-illustration" style="background-color:whitesmoke">
    ...
    <section>
        ...
        <lottie-player src="https://lottie.host/96cce79d-e4a6-48db-891e-0d4e7e1ea732/DRx37PkYza.json"
            ...
            style="position:fixed;width: 900px; height: 900px;z-index:-1;top:-200px;left:-50px;opacity:0.04" loop
            autoplay>
        </lottie-player>

        <lottie-player src="https://lottie.host/96cce79d-e4a6-48db-891e-0d4e7e1ea732/DRx37PkYza.json"
            background="transparent" speed="1"
            style="position:fixed;width: 900px; height: 900px;z-index:-1;top:90px;left:400px;opacity:0.04" loop
            autoplay>
        </lottie-player>
        <div class="form-bg">
            <div class="container">
