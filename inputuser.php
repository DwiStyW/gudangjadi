...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
    ...
    <title>Input User | SI Gudang</title>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">											
                                                <div class="all-form-element-inner">
													<form enctype="multipart/form-data" action="insertus.php" method="post">
														...
														<div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <input name="role" value="user" class="form-control" id="role" readonly="readonly"/>																	
                                                                </div>
                                                            </div>
                                                        </div>
