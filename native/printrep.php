...
<head>
  ...
  <title>Print Report All | SI Gudang</title>
...
<body>
  ...
  <table border="1" width="100%">
    ...
    <tbody>
      <?php
      $tampil = mysql_query("SELECT * FROM master, riwayat  WHERE master.kode=riwayat.kode && riwayat.tglform between '$mulai' AND '$end' ORDER BY kdgol ASC, kode ASC");
