...
<head>
    ...
    <title>Report All | SI Gudang</title>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="all-form-element-inner">
                                                <form enctype="multipart/form-data" action="tampilreport.php" method="post">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <div class="login-horizental cancel-wp pull-left">
                                                                        ...
                                                                        <a href="reportsa.php"><button class="btn btn-sm btn-warning" type="button">Saldo Akhir Stock </button></a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
