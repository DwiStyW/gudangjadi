          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="sparkline8-list shadow-reset">
                ...
                <div id="toolbar">
                  <a target="_blank" href="printrep.php?start=<?php echo $start; ?>&end=<?php echo $end; ?>">
                    <button class="btn btn-sm btn-success login-submit-cs" type="submit">Print</button></a>
                  <a href="report.php"><button class="btn btn-sm btn-white" type="button">Kembali</button></a>
                </div>
                <div class="sparkline8-graph">
                  <div class="datatable-dashv1-list custom-datatable-overright">
                    ...
                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                      ...
                      <tbody>
                        <?php
                        $tampil = mysql_query("SELECT * FROM master, riwayat  WHERE master.id=riwayat.kode && riwayat.tglform between '$start' AND '$end' ORDER BY kdgol ASC, kode ASC");
                        $tampil1 = mysql_query("SELECT * FROM master ORDER BY kode ASC");
