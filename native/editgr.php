...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
    ...
    <title>Edit Golongan | SI Gudang</title>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">											
                                                <div class="all-form-element-inner">
													<form enctype="multipart/form-data" action="updategr.php" method="post">
                                                    <?php
                                                    ...
                                                    <input name="no" type="hidden" class="form-control" id="no" value="<?php echo $data['id'];?>" readonly="readonly"/> 
														...
														<div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Kode Group</label>
                                                                </div>
                                                                <div class="col-lg-9">
                                                                    <input name="kdgrup" type="number" class="form-control" id="kdgrup" placeholder="Kode Group" value="<?php echo $data['kdgrup'];?>" required/>                                                                   
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Nama Group</label>
                                                                </div>
                                                                <div class="col-lg-9">
                                                                    <input name="namagrup" type="text" class="form-control" id="namagrup" placeholder="Nama Group" value="<?php echo $data['namagrup'];?>" required/>                                                                   
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Kode Sub Group</label>
                                                                </div>
                                                                <div class="col-lg-9">
                                                                    <input name="kdsubgr" type="text" class="form-control" id="kdsubgr" placeholder="Nama Group" value="<?php echo $data['kdsubgr'];?>" required/>                                                                   
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Nama Sub Group</label>
                                                                </div>
                                                                <div class="col-lg-9">
                                                                    <input name="nama" type="text" class="form-control" id="nama" placeholder="Nama Group" value="<?php echo $data['nama'];?>" required/>                                                                   
                                                                </div>
                                                            </div>
                                                        </div>
