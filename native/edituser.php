...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
    ...
    <title>Edit User | SI Gudang</title>
													...
													<input name="no" type="hidden" class="form-control" id="no" value="<?php echo $data['user_id'];?>" />
														<div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <input name="username" type="text" class="form-control" id="username" value="<?php echo $data['username'];?>" required/> 
														...
														<div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <input name="password" type="password" class="form-control" id="password" value="<?php echo md5($data['password']);?>" required/>
                                                                </div>
                                                            </div>
                                                        </div>
														<div class="form-group-inner">   
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-9">
                                                                        <div class="login-horizental cancel-wp pull-left">
                                                                            <a href="user.php"><button class="btn btn-white" type="button">Kembali</button></a>
