...
$_SESSION['start_time'] = time();
 ...
 if ($role=='user'){
	 echo "<script>alert('Anda Tidak Mempunyai Hak Akses!'); window.location = 'index.php'</script>";
 }
?>
<!doctype html>
...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
    ...
    <title>User All | SI Gudang</title>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="nav nav-tabs custom-menu-wrap">
                        ...
                        <li><a href="riwayat.php">Report per Barang</a></li>
                        <li><a href="reportgr.php">Report per Group</a></li>
                        <li><a href="report.php">Report All</a></li>
                        <?php
                            $role= $user_login['role'];
                            if ($role=='admin'){
                        ?>
                        <li class="active"><a href="user.php">Admin</a>
                        <?php } ?>              
                        </li>
                    </ul>
                    ...
                    <div class="sparkline8-list shadow-reset">
                        ...
                        <div class="sparkline8-graph">
                            <div class="datatable-dashv1-list custom-datatable-overright">
                                <div id="toolbar">
                                        <a href="inputuser.php"><button class="btn btn-sm btn-primary login-submit-cs" type="submit">Input User Baru</button></a>										
                                ...
                                <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
									<thead>
										<tr>                                                    
											...
											<th data-field="tglform">Username</th>
											<th data-field="noform">Password</th>
											<th data-field="kode">Fullname</th>
											<th data-field="nama">Role</th>
									...
									<tbody>
										...
										<tr>												                                                  
											...
											<td><a class="btn btn-sm btn-primary" href="edituser.php?hal=edit&kd=<?php echo $data['user_id'];?>"><i class="fa fa-edit"></i> Edit</a>
												<a class="btn btn-sm btn-danger" href="hapusbahan.php?hal=<?php echo $data['kode'];?>&kd=<?php echo $data['no'];?>"><i class="fa fa-wrench"></i> Hapus</a></td>
										</tr>
										<?php $no++;} ?>                                                
									</tbody>
                                 </table>
