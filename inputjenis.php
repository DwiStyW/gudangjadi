...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
    ...
    <title>Input Jenis | SI Gudang</title>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">											
                                                <div class="all-form-element-inner">
													<form enctype="multipart/form-data" action="insert.php?mode=5.php" method="post">    
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <input name="kdjenis" type="text" class="form-control" id="kdjenis" placeholder="Kode Jenis" required/>                                                              
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <input name="namajenis" type="text" class="form-control" id="namajenis" placeholder="Nama Jenis" required/>
                                                                </div>
                                                            </div>
                                                        </div>
