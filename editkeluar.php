...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
    ...
    <title>Edit Bahan Keluar | SI Gudang</title>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">											
                                                <div class="all-form-element-inner">
													<form enctype="multipart/form-data" action="update.php?mode=5.php" method="post">
                                                    <?php
													$query = mysql_query("SELECT * FROM riwayat WHERE no='$_GET[kd]'");
													$data  = mysql_fetch_array($query);
													?>                                                    
                                                        <input name="no" type="hidden" class="form-control" id="no" value="<?php echo $data['no'];?>" readonly="readonly"/> 
