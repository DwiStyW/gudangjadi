...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
    ...
    <title>Input Golongan | SI Gudang</title>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">											
                                                <div class="all-form-element-inner">
													<form enctype="multipart/form-data" action="insert.php?mode=4.php" method="post">    
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Kode Golongan</label>
                                                                </div>
                                                                <div class="col-lg-9">
                                                                    <input name="kdgol" type="text" class="form-control" id="kdgol" placeholder="Kode Golongan" required/>                                                              
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <input name="namagol" type="text" class="form-control" id="namagol" placeholder="Nama Golongan" required/>							
                                                                </div>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-9">
                                                                        <div class="login-horizental cancel-wp pull-left">
                                                                            <a href="golongan.php"><button class="btn btn-white" type="button">Kembali</button></a>
